...
import Kathmanduimg from '../../assets/Kathmanduimg.jpeg';
...
const KathmanduValley = () => {
 ...
 {/*left grid */}
    ...
    <Typography variant="hTitle" sx={{ my: {xs: "10vh", sm: "15vh"}, textAlign: "left" }}>
          ...
          <Box component="img" src={Kathmanduimg} sx={{height: "auto", width: "100%"}}/>
          </Grid>


        {/* leftB grid */}
<Grid item>
<Typography variant="body2" sx={{my: '5vh'}}>
Kathmandu Valley Tour
</Typography>
    <Typography variant="body2">
    Welcome to Nepal! When you arrive in Kathmandu – you will be met by our representatives at the airport and greet transfer to your hotel. Kathmandu valley, the capital city, is the cultural and political hub of Nepal. Recorded history of Nepal begins with the Lichhivis who came to power in 400 AD. With then the nation began to prosper in art, culture, painting, architecture, and sculptures. The Mallas who succeeded Lichhivis gave a new turn to this prosperity by transforming the small Kingdoms of Kathmandu, Patan and Bhaktapur into an open-air museum of art and architecture. Kathmandu valley is the first stop for the majority of visitors to Nepal. Your guided sightseeing include all-important historical places, Durbar squares, temples complexes of the valley and some of the scenic hill stations around the valley rim for short walks and easy hiking with panoramic Himalayan Mountain view.    
    </Typography>
</Grid>
    </Grid>
