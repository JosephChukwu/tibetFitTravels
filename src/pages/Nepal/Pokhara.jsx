...
import PokharaTourImg from "../../assets/PokharaTourimg.jpg";
...
const Pokhara = () => {
 ...
 {/*right grid */}
    ...
    Pokhara Tour
          ...
          <img src={PokharaTourImg} alt="PokharaTourImg" style={{height: "auto", width: "100%"}} />
          </Grid>


 {/*rightB grid */}
    <Grid container sx={{mt: "5vh"}}>
<Typography variant='body2'>Pokhara Tour</Typography>
    </Grid>
